...
(function(){
  ...
  writeAllIndex = function(db){
    ...
    data = nestedSubcategories(db.projects, db.projectsRejected);
    path = 'all/index';
    view = viewPath(path);
    options = {
      pretty: true,
