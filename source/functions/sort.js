...
(function(){
  ...
  subcategoriesAll = function(db){
    var tree, subcategories, i$, len$, category, j$, ref$, len1$, subcategory;
    ...
    return subcategories = sortBy(function(it){
  ...
  exports.subcategoriesAll = subcategoriesAll;
  exports.nestedSubcategories = nestedSubcategories;
