translations =
  ...
  "intro": "<strong>退出 PRISM， NSA 的全球性資訊監督程式。</strong> 利用這些專有軟件的免費替代品,來停止把你的上網行為呈報給美國政府。"
  "menu": "Menu"
  "proprietary": "私有軟體*"
  ...
  "email-client": "桌面郵件用戶端"
  "icedove": "完全自由版本的 Mozilla Thunderbird。"
  ...
  "chatsecure-android": "私密且安全的 Android 通訊軟體(使用 OTR 協定)。"
  ...
  "online-transactions": "線上金流服務"
  "cryptocoins-title": "另一個加密貨幣選擇。"
  ...
  "vpn-client-note": "--"
  "web-analytics": "網站訪客狀態分析"
  "web-analytics-note": "<p>--</p>."
  "dns-provider": "DNS 服務供應商"
  ...
  "fsf-definition-title": "*本網站使用<strong>自由軟體基金會&rsquo;s</strong>對自由軟體（free software）的定義。"
  "fsf-quote": "&ldquo;自由軟體（free software）&rdquo; 的意思是尊重使用者&rsquo; 自由和社群。概略來說，<strong>使用者擁有執行、複製、分享、研究、更動和改善軟體的自由</strong>。有了這些自由，這些使用者（包含個人和團體）得以控制該程式及其功能。"
