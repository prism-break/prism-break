translations =
  ...
  "site-introduction": "<strong>Εναλλακτικές για την παράκαμψη του PRISM, του προγράμματος παγκόσμιας παρακολούθησης δεδομένων της NSA.</strong> Σταματήστε την αναφορά στην Αμερικάνικη κυβέρνηση δραστηριότητας στο διαδίκτυο με αυτά τα δωρεάν εναλλακτικά λογισμικά."
  "Menu": "Menu"
  ...
  The: "Το"
  "site-media-index-title": "Αναφορές στα Μέσα Μαζικής Ενημέρωσης."
  Catalan: "Catalan"
  German: "Γερμανικά"
  English: "Αγγλικά"
  Spanish: "Ισπανικά"
