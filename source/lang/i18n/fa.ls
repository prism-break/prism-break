translations =
  "site-title": "PRISM Break - از پریسم، برنامه‌ی جمع‌آوری اطّلاعات آژانس امنیت ملّی امریکا بیرون بیاید"
  "meta-description": "از پریسم، برنامه‌ی جمع‌آوری اطّلاعات آژانس امنیت ملّی امریکا بیرون بیایید. با این جایگزین‌های آزاد به جای نرم‌افزارهای انجصاری، به گزارش دادن فعّالیت‌های برخط خود به دولت امریکا پایان دهید."
  "intro": "<strong>از دست پروژه 'پریسم' یعنی برنامه نظارت جهانی آژانس امنیت ملی آریکا راحت شوید!</strong> با استفاده از این جایگزین‌های آزاد برای برنامه‌های مالکیت طلبانه، مانع گزارش فعالیت‌های آنلاین خود به دولت آمریکا (و دولت‌های دیگر) شوید."
  "menu": "Menu"
  "proprietary": "مالکیت طلبانه*"
  "free-alternative": "جایگزین آزاد"
  "notes": "یادداشت"
  "operating-system": "سیستم عامل"
  "trisquel": "توزیع کاربر محور و مورد حمایت اف‌اس‌اف"
  "operating-system-note": "<p>اپل، گوگل و مایکروسافت اعضای پریسم هستند. سیستم‌های عامل انحصاری آن‌ها نمی‌تواند اطّلاعات شخصی شما را از NSA محفوظ بدارد.</p><p>این ما را با دو جایگزین آزاد مواجه می‌کند: <strong><a href='https://www.gnu.org/distros/free-distros.html'>گنو/لینوکس</a></strong> و <strong><a href='https://en.wikipedia.org/wiki/Comparison_of_BSD_operating_systems'>بی‌اس‌دی</a></strong>.</p> <p>گنو/لینوکس جامعه‌ی بزرگ‌تری برای کمک به مهاجرت شما دارد. توصیه می‌شود کاوش خود را با گشتن به دنبال یک <a href='http://distrowatch.com/'>توزیع گنو/لینوکس</a> که مناسب نیازهاییتان باشد آغاز کنید.</p> <p>چرا اوبونتو نه؟ اوبونتو انتخاب جندان مطمينی نیست، زیرا که برخی معتقدند در گذشته حاوی <a href='https://www.gnu.org/philosophy/ubuntu-spyware.html'>جاسوس‌افزار</a> بود.</p> <p>توجّه: PRISM Break نسخه‌ی بدون رمزگشای <strong>لینوکس مینت</strong> را توصیه می‌کند، چرا که نسخه‌های دیگر آن شامل برنامه‌هایی با پتنت‌های نرم‌افزاری هستند. <a href='https://github.com/nylira/prism-break/issues/126#issuecomment-19898104'>اطّلاعات بیش‌تر</a>.</p>"
  ...
  "android": "Android"
  "android-note": "<p><strong>CyanogenMod</strong> پروانه: &ldquo;CyanogenMod هنوز شامل کدهای مخصوص سخت‌افزاری است که به کندی در حال بازمتن شدن هستند.&rdquo; &mdash;<a href='https://en.wikipedia.org/wiki/CyanogenMod#Licensing'>ویکی‌پدیا</a></p><p><strong>F-Droid</strong> جایگزینی آزاد برای فروشگاه اپلیکیشن گوگل پلی است</p><p>We believe that replacing your Android device's OS with open source software can greatly improve the privacy and security of your device. However, it is possible that your device's closed-source hardware will still remain capable of certain privacy violations.</p>"
  "mobile-os": "iOS &amp; WP"
  ...
  "web-browser-note": "<p>از ترکیب <strong>مرورگر تور</strong> و یک مرورگر وب آزاد به انتخاب خودتان برای وب‌گردی استفاده کنید.</p> <p>سعی کنید تا جای ممکن از <strong>مرورگر تور</strong> استفاده کنید. مرور با تور ممکن است کمی کندتر باشد، ولی بسیار امن‌تر است.</p> <p>توجّه: <strong>فایرفاکس موزیلا</strong> تکنیکالی به طور کامل نرم‌افزار آزاد نیست، زیرا که موزیلا افزونه‌های غیرآزاد را در وبگاهش توصیه می‌کند.</p>"
  "web-browser-plugins": "افزونه مرورگرها"
  "web-browser-addons-note": "<p>با نصب Adblock Edge، Disconnect، HTTPS Everywhere و NoScript در مرورگرتان از محرمانگی خود محافظت کنید و ویگاه‌ها را از ردیابی خود منع کنید.</p> <p>چرا Adblock Plus نه؟ Adblock Plus &ldquo;تبلیغات قابل قبول&rdquo; را به صورت پیش‌فرض نمایش می‌دهد و حافظه‌ای بیش‌تر از <strong>Adblock Edge</strong> مصرف می‌کند.</p> <p>چرا گوستری نه؟ گوستری یک پلاگین انحصاری است. به جای آن از <strong>Disconnect</strong> استفاده کنید.</p>"
  ...
  "email-service-note": "<p><strong>رایزآپ</strong> در امریکا میزبانی می‌شود، البته مهم نیست.</p><p>چرا هاش‌میل نه؟ <a href='https://en.wikipedia.org/wiki/Hushmail#Compromises_to_email_privacy'>&ldquo;compromises to email privacy&rdquo;</a> را ببینید.</p>"
  "email-client": "برنامه ای‌میل"
  "icedove": "ورژن آزاد برنامه تاندربرد"
  "email-client-note": "<p>Note: <strong>تاندربرد موزیلا</strong> تکنیکالی به طور کامل نرم‌افزار آزاد نیست، زیرا که موزیلا افزونه‌های غیرآزاد را در وبگاهش توصیه می‌کند.</p>"
  "email-encryption": "رمزنگاری ایمیل"
  "email-encryption-note": "<p>&ldquo;Pretty Good Privacy (PGP) یک برنامه‌ی رایانه‌ای رمزگذاری و رمزگشایی اطّلاعات است که محرمانگی رمزی و صحّت داده‌های تبادلی را فراهم می‌کند. PGP اغلب برای امضا کردن، رمزگذاری و رمزگشایی متون، ای‌میل‌ها، پرونده‌ها، شاخه‌ها و پارتیشن‌های کامل دیشک برای افزایش امنیت ارتباطات ای‌میلی به کار می‌رود.&rdquo;</p><p>&mdash; <a href='https://en.wikipedia.org/wiki/Pretty_Good_Privacy'>ویکی‌پدیا</a>"
  "instant-messaging": "برنامه پیام رسان"
  "jappix": "Instant messaging web application with advanced social networking features."
  "chatsecure-android": "اس‌ام‌اس امن با حفظ حریم شخصی"
  ...
  "cloud-storage": "ذخیره‌سازی آنلاین"
  ...
  "media-publishing": "انتشار فیلم و عکس"
  ...
  "vpn-client-note": "--"
  "web-analytics": "تحیل آمار بازدید سایت"
  "web-analytics-note": "<p>--</p>."
  "dns-provider": "فراهم کننده سرویس نام دامنه"
  ...
  "invite-only": "فقط با دعوت‌نامه"
  "approval-required": "نیاز به تأییدیه"
  "usa-hosted": "USA hosted"
  "paid-service": "paid service"
  "paid-software": "paid software"
  "newbies-choice": "مناسب برای تازه‌کاران"
  "editors-choice": "انتخاب نویسنده"
  ...
  "fsf-definition-title": "*این سایت از تعریف <strong>بنیاد نرم‌افزار آزاد</strong> از برنامه آزاد استفاده می‌کند"
  "fsf-quote": "برنامه آزاد برنامه‌ای است که آزادی کاربر و جامعه کاربری را محترم می‌شمرد. عموما <strong>کاربر آزاد است برنامه را در هر جا اجرا، کپی، توزیع، مطالعه، تغییر و بهبود ببخشد</strong>. با این آزادی‌ها، کاربران (هم فردی و هم جمعی) برنامه و آنچه برنامه برای آنها انجام می‌دهد را کنترل می‌کنند."
  "eff-title": "شما هم می‌توانید در مرکز مشارکت <strong>EFF</strong> کاری بر علیه پریسم انجام دهید."
  "eff-quote-1": "<strong>برنامه نظارت گسترده‌ای آشکار شده است</strong>"
  "eff-quote-2": "گزارش‌های اخیر توسط روزنامه گاردین و واشنگتن پست، برنامه مخفیانه جاسوس بر روی اطلاعات تلفن و فعالیت‌های اینترنتی را تایید کرد. هم‌اکنون زمان یک حرکت کامل بر علیه برنامه‌های جاسوس آمریکا و پایان بخشیدن به نظارت‌های بی‌قید و شرط است."
  "more": "بیشتر &hellip;"
  "the": ""
  "media-title": "در رسانه‌ها"
  "catalan": "کاتلن"
  "german": "آلمانی"
  "english": "انگلیسی"
  "spanish": "اسپانيايى"
  ...
  "russian": "روسی"
  "swedish": "سوئدی"
  "chinese-simplified": "چینی تسهیل شده"
