translations =
  ...
  "site-introduction": "<strong>از دست پروژه 'پریسم' یعنی برنامه نظارت جهانی آژانس امنیت ملی آریکا راحت شوید!</strong> با استفاده از این جایگزین‌های آزاد برای برنامه‌های مالکیت طلبانه، مانع گزارش فعالیت‌های آنلاین خود به دولت آمریکا (و دولت‌های دیگر) شوید."
  "Menu": "Menu"
  "Proprietary": "مالکیت طلبانه*"
  "Free Alternatives": "جایگزین آزاد"
  "Notes": "یادداشت"
  ...
  "newbie's choice": "مناسب برای تازه‌کاران"
  "editor's choice": "انتخاب نویسنده"
  ...
  "more": "بیشتر &hellip;"
  The: ""
  "site-media-index-title": "در رسانه‌ها"
  Catalan: "کاتلن"
  German: "آلمانی"
  English: "انگلیسی"
  Spanish: "اسپانيايى"
