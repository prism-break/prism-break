translations =
  ...
  "site-introduction": "<strong>PRISMを断固拒否しましょう。</strong>PRISMとは、NSA（アメリカ国家安全保障局）の世界規模のデータ監視プログラムです。以下に挙げる（商業的な）プロプライエタリ・ソフトウェアを使わないで、替わりのフリーソフトウェアを使ってください。オンライン上のあなたの行動がアメリカ政府に報告されるのを止めましょう。"
  "Menu": "Menu"
