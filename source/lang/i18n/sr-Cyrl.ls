translations =
  ...
  "site-introduction": "Изван ПРИСМ, НСА-иног глобалног програма за надзор.</strong> Прекини извештавати Америчку владу о својим интернет активностима уз помоћ бесплатних, отворених алтернатива."
  "Menu": "Menu"
  "Proprietary": "власнички*"
  "Free Alternatives": "Free alternative"
  "Notes": "Notes"
  "Operating System": "Оперативни систем"
  "trisquel": "ФСФ подржане, за кориснике прилагођене ГНУ/Линукс дистрибуције."
  "web-browser": "Интернет прегледачи"
  "icecat": "ГНУ верзија Фајерфокса."
  "web-browser-plugins": "Dodaci za internet pregledače"
  "web-search": "Интернет претраживачи"
  "dns-provider": "ДНС провајдери"
  ...
  "vpn-client-note": "--"
  "email-service": "Листа алтернативних шифрованих дигиталних валута"
  "email-client": "Емаил десктоп клијенти"
  "icedove": "Бесплатна верзија Мозилиног Тандербирда."
  "email-encryption": "Емаил шифровање"
  "webpg": "ГнуПГ/ПГП у прегледачу."
  "maps": "Мапе"
  ...
  "maps-note": "<p>--</p>"
  "cloud-storage": "Облак складишта"
  "scheduling": "Scheduling"
  "social-networking": "Друштвене мреже"
  "protocol": "Protocol"
  "instant-messaging": "Дописивање"
  "video-voip": "Видео конференције/ВоИП"
  "media-publishing": "Објављивање медија"
  ...
  "web-analytics": "Интернет анализе"
  "android-app-store": "Андроид продавнице"
  "chatsecure-android": "Приватано и сигурно ОТР дописивање за Андроид."
  "mobile-os": "iOS &amp; WP"
  ...
  "xmpp-server-notes": "<blockquote><p>&ldquo;Extensible Messaging and Presence Protocol (XMPP) is a communications protocol for message-oriented middleware based on XML (Extensible Markup Language). The protocol was originally named Jabber, and was developed by the Jabber open-source community in 1999 for near real-time, instant messaging (IM), presence information, and contact list maintenance. Designed to be extensible, the protocol has also been used for publish-subscribe systems, signalling for VoIP, video, file transfer, gaming, Internet of Things applications such as the smart grid, and social networking services.&rdquo;</p><footer>&mdash; <cite><a href='https://en.wikipedia.org/wiki/XMPP'>Wikipedia</a></cite></footer></blockquote>"
  "sip-server-title": "Sip-server"
  "sip-server-notes": "<blockquote><p>&ldquo;The Session Initiation Protocol (SIP) is a signaling communications protocol, widely used for controlling multimedia communication sessions such as voice and video calls over Internet Protocol (IP) networks.&rdquo;</p><footer>&mdash; <cite><a href='https://en.wikipedia.org/wiki/Session_Initiation_Protocol'>Wikipedia</a></cite></footer></blockquote>"
  "hardware-software": "Hardware &amp; software setup"
  "self-hosting-notes": "--"
  "add": "додај"
  "mostly-free": "најчешће бесплатни*"
  "rec-non-free": "препоручени додаци*"
  "advanced": "напредно"
  "partly-proprietary": "делимично власнички*"
  "invite only": "само по позиву"
  "newbie's choice": "по одлуци новајлија"
  "editor's choice": "по одлуци уредника"
  "approval required": "approval required"
  "fsf-definition-title": "*Овај сајт користи <strong>ЕСФ-ов</strong> дефиниција слободног софтвера."
  "fsf-quote": "&ldquo;Бесплатан софтвер&rdquo; значи софтвер који поштује корисникову слободу и комуникативност. Грубо, <strong>корисници имају слодобу да покрећу, копирају, дистрибуирају, проучавају, мењају и унапређују софтвер</strong>."
  "eff-title": "Крени у акцију против ПРИСМ-е у центру акције <strong>ЕФФ</strong>-а."
  "eff-quote-1": "<strong>МАСОВНИ НАДЗОР ОТКРИВЕН</strong>"
  "eff-quote-2": "Недавни извори Гардијана и Вашинктон Поста потвржују тајни програм за шпијунажу телефона и Интернет активности."
  "more": "опширније &hellip;"
  The: ""
  "site-media-index-title": "Споменути у медијима."
  Catalan: "Каталонски"
  Dutch: "Холандски"
  English: "Енглески"
  French: "Француски"
  ...
  "darknet-note": "<p>&ldquo;A darknet is an anonymizing network where connections are made only between trusted peers.</p><p>Darknets are distinct from other distributed P2P networks as sharing is anonymous, and therefore users can communicate with little fear of governmental or corporate interference.&ldquo;</p><p>&mdash;<a href='https://en.wikipedia.org/wiki/Darknet_%28file_sharing%29'>Wikipedia</a></p>"
