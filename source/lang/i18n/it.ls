translations =
  ...
  "android": "Android"
  "android-note": "<p><strong>CyanogenMod</strong> licensing: &ldquo;CyanogenMod does still include various hardware-specific code, which is also slowly being free anyway.&rdquo; &mdash;<a href='https://en.wikipedia.org/wiki/CyanogenMod\#Licensing'>Wikipedia</a></p><p>If <strong>Replicant</strong> supports your <a href='http://replicant.us/supported-phones/'>Android device</a>, you should definitely use it instead of Cyanogenmod, as Replicant is fully free and runs without relying on proprietary system code.</p><p>We believe that replacing your Android device's OS with open source software can greatly improve the privacy and security of your device. However, it is possible that your device's closed-source hardware will still remain capable of certain privacy violations.</p>"
  "mobile-os": "iOS &amp; WP"
  ...
  "web-browser-note": "<p>Combina l'utilizzo di <strong>Tor Browser</strong> ed un altro browser per navigare. Cerca di utilizzare Tor il più possibile. Navigherai più lentamente, ma sarai molto più anonimo. Assicurati di <a href='https://www.torproject.org/docs/faq.html.en'>conoscere le basi di Tor</a> prima di utilizzarlo.</p><p>Note: Signing in to PayPal or a banking website across the Tor network may trip the site's fraud protection software. Users should also be aware that signing into non-HTTPS websites may result in your credentials being captured by a malicious exit node.</p><p><strong>Mozilla Firefox</strong> uses Google search by default. Google search should be replaced by a more <a href='\#web-search'>private alternative</a>.</p><p><a href='http://www.geticeweasel.org/'>Iceweasel</a> is a de-branded Mozilla Firefox alternative for Debian based distributions.</p><p>Why are Chromium, SRWare Iron, et al. not recommended on PRISM Break? <a href='https://github.com/nylira/prism-break/issues/169'>More info here.</a></p>"
  "web-browser-plugins": "Componenti aggiuntivi per browser internet"
  ...
  "maps-note": "<p>--</p>"
  "email-service": "Servizi email"
  "email-service-note": "<p><strong>Riseup</strong> is hosted in the USA, in case that matters.</p><p>Why not Hushmail? See <a href='https://en.wikipedia.org/wiki/Hushmail\#Compromises_to_email_privacy'>&ldquo;compromises to email privacy&rdquo;</a>.</p>"
  "email-client": "Client di posta elettronica"
  "icedove": "Versione libera di Mozilla Thunderbird."
  ...
  "chatsecure-android": "Messaggistica OTR privata e protetta per Android."
  ...
  "video-voip": "Videoconferenze/VoIP"
  ...
  "media-publishing": "Pubblicazione di contenuti"
  "mediacrush-self": "You can also run self-hosted instances of MediaCrush."
  "noblogs": "Piattaforma di pubblicazione contenuti basata su wordpress, da autistici.org"
  ...
  "online-transactions": "Transazioni su internet"
  "cryptocoins-title": "Cripto-valute alternative."
  ...
  "tor-hidden-services": "La rete Tor permette l'accesso ai siti *.onion."
  ...
  "newbies-choice": "ideale per iniziare"
  "editors-choice": "consigliato"
  ...
  "fsf-definition-title": "*Questo sito usa la definizione di software libero della <strong>Free Software Foundation</strong>."
  "fsf-quote": "L&\#39;espressione &ldquo;software libero&rdquo; si riferisce al rispetto delle libert&agrave; degli utenti e della comunit&agrave;. In breve, gli utenti hanno la libert&agrave; di eseguire, copiare, distribuire, studiare, cambiare e migliorare il software. Tramite queste libert&agrave; gli utenti (individualmente o nel loro complesso) controllano il programma e le sue funzioni."
  ...
  "more": "per saperne di pi&ugrave; &hellip;"
  "the": "La"
  "media-title": "Menzioni sui media."
  "catalan": "Catalano"
  "german": "Tedesco"
  "english": "Inglese"
  "spanish": "Spagnolo"
