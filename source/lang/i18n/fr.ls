translations =
  ...
  "jappix": "Application web de messagerie instantanée qui propose des services avancés de réseaux sociaux."
  "chatsecure-android": "Messagerie OTR sécurisée et privée pour Android."
  "instant-messaging-note": "<p>Jetez également un œil à <strong>Cryptocat</strong> dans la section plug-in pour navigateur web</p></p>"
  "video-voip": "Vidéo-conférence / Voix sur IP"
  "video-voip-note": "<p><strong>Jitsi</strong> est une solution chiffrée pour remplacer la plupart des tâches que Skype peut effectuer.</p><p><strong>Mumble</strong> est un client de chat audio open-source dans la même veine que Ventrilo et TeamSpeak.</p><p><a href='http://www.webrtc.org/'>WebRTC</a> est un ensemble d'API de communication à travers le Web."
  "social-networking": "Réseaux sociaux"
  "protocol": "Protocole"
  "social-networking-note": "<p>--</p>"
  "cloud-storage": "Stockage en ligne (ou cloud)"
  "cloud-storage-note": "<p>Pourquoi pas MEGA&nbsp;? MEGA est certes gratuit, mais le logiciel est propriétaire.</p><p>Pourquoi pas SpiderOak&nbsp;? SpiderOak est lui-aussi un logiciel propriétaire.</p><p>Pourquoi pas Tarsnap&nbsp;? Tarsnap est partiellement propriétaire et héberge vos données sur Amazon Web Services.</p>"
  "scheduling": "Scheduling"
  "online-office-suite": "Online office suite"
  "online-office-suite-note": "<p>Le projet <strong>etherpad</strong> maintient une liste de <a href='https://github.com/ether/etherpad-lite/wiki/Sites-that-run-Etherpad-Lite'>sites qui proposent des services grâce à etherpad</a>. Please only choose from the services that use SSL, and research the site's background before trusting them with your data.</p><p><a href='#email-service'><strong>Riseup</strong></a> propose aussi des adresses email, XMPP, et un service de chat, tous accessible via <a href='#meshnet'>Tor Hidden Service</a> addresses. La liste de ces adresses est <a href='https://www.riseup.net/en/tor#riseups-tor-hidden-services'>disponible içi</a>.</p><p><strong>ProtectedText</strong> chiffre/déchiffre le texte dans le navigateur, et le mot de passe (ou il est hashé) n'est jamais envoyé au serveur - de telle sorte que le texte ne peut pas être déchiffré même si les autorités le demandent.</p>"
  "media-publishing": "Publication média"
  "mediacrush-self": "Vous pouvez également exécuter des instances auto-hébergés de MediaCrush."
  "noblogs": "Plateforme de publication de blog basé sur WordPress, par autistici.org."
  "imgbi-self": "You can also run self-hosted instances of img.bi."
  "media-publishing-note": "<p>L'<strong>auto-hébergement</strong> est important. Héberger votre blog sur Wordpress.com n'est pas plus sécurisé pour vos données que Blogger ou Tumblr.</p><p><strong>img.bi</strong> also accessible through <a href='#anon-network'>Tor Hidden Service</a> (<a href='http://imgbifwwqoixh7te.onion/'>imgbifwwqoixh7te.onion</a>) and as <a href='#anon-network'>Eepsite</a> (<a href='http://imgbi.i2p/?i2paddresshelper=HlMhQ2p~WB9WiehsAa2IDfndqXTMTOeYfOIxpeQH5hSeXLxtwUhd9FsaYmXM-hq66jRREcTpBqNmbILwQsInuBnQ7PZTgLel4tdKMrKhUlxDout4eZ6uRRN6QMWX9YzDCV0cmLBWHRcZlFaBirs3RbF5neUXgdnNqgcvdanQEt5-XN05I5JrIe~Dld9vQ1Z0WSn10BcOtXDm7uxnaHqJUbhtfOgmFoGAxF~di220GpRCzDP6Eg9NRIwAGGFxH8Y7PEOmlqiUCOn5aHwxk2msqrFLzBy6aVWq-e8etrhDxckPvJby7G13QCmVCO-cOOYOObP6bk51t99t5DNxIsGEuoEaUHyVNqAf9jvMjAcqpt6Gdk8slcV528rnSXJ6Vu2gcYYnb~kmt7wtvgm46xTE0OXxdDAmbtsRu~U6oSxRROkw02Q7hdnMmiF86dTYxx-dQ6H8aPQJV1SM5cNlv3XfqBl-V0-TounGNPcj4279s4DUs7-FfhuKYJjbZj5KOlPNAAAA'>imgbi.i2p</a>).</p><p>Warning: Using avatars in WordPress will activate Gravatar, which which will send your email address to gravatar.com. Avatars are activated by default and can be turned off under &ldquo;Settings &gt; Discussion &gt; Avatars&rdquo;.</p><p>Warning: MediaCrush includes <strong>Google Analytics</strong> and <strong>Google Adsense</strong> if you do not have Do Not Track enabled.</p>"
  "online-transactions": "Transactions en ligne"
  "cryptocoins-title": "Monnaies cryptographiques alternatives."
  "cryptocoins": "Liste des monnaies numériques alternatives chiffrées."
  "online-transactions-note": "<p><strong>Bitcoin</strong> est une monnaie électronique décentralisée conçue en 2009</p><p>&laquo;&nbsp;C'est peut-être la monnaie TCP/IP.&nbsp;&rauo; &mdash; Paul Buchheit</p>"
  "digital-distribution": "Distribution digitale"
  "digital-distribution-note": "<p><strong>Desurium</strong> est seulement le client. Vous devez encore faire confiance/dépendre des <a href='http://www.desura.com'>services desura</a> propriétaires.</p>"
  "vpn": "Virtual Private Network (VPN)"
  "autisticivpn": "Service de VPN sécurisé personnel fourni par Autistici/Inventati."
  ...
  "dns-provider-note": "<p>Google Public DNS enregistre en permanence le nom de votre FAI et des informations géographiques à des fins d'analyse. Votre adresse IP est par ailleurs enregistrée pour 24 heures.</p><p><strong>OpenNIC</strong> n'a pas adopté de politique officiel concernant la rétention des enregistrements et leur consultation. Plus d'information <a href='http://wiki.opennicproject.org/Tier2'>ici</a>.</p>"
  "anon-networks": "Réseau Anonymiseur"
  "tor-hidden-services-title": "Services Tor cachés"
  "tor-hidden-services": "Le réseau Tor permet l'accès aux sites en <tt>.onion</tt>."
  "anon-network-note": "<p>--</p>"
  "meshnet": "Meshnet"
  "meshnet-project": "Une alternative décentralisée à Internet."
  "meshnet-note": "<p>Un réseau maillé est un réseau pair-à-pair décentralisé, avec des liens physiques contrôlés par l'utilisateur qui sont habituellement sans fil.</p><p>&laquo;&nbsp;Le réseau maillé (topologie) est un type de réseau dans lequel chaque nœud doit non seulement capturer et diffuser sa propre information, mais aussi servir de relai pour les autres nœuds, à savoir, collaborer à la propagation de l'information dans le réseau.&nbsp;&raquo;</p><p>&mdash; <a href='https://fr.wikipedia.org/wiki/Topologie_mesh'>Wikipédia</a></p>"
  "server-os-title": "Système d'exploitation pour serveur"
  "server-os-notes": "--"
  "file-encryption": "Chiffrement des fichiers"
  "dmcrypt": "Sous-système transparent de chiffrement de disques inclus dans le noyau Linux."
  "file-encryption-note": "<p>Bien que <strong>TrueCrypt</strong> soit open source, il est dévellopé d'une manière fermé et risque de recevoir moins d'examen qu'un projet comparable dévellopé ouvertement. Cela dit, c'est encore probablement la meilleure solution pour le chiffrement de fichiers sur Windows et OS X.</p><p>Si vous utilisez GNU/Linux, <strong>dm-crypt</strong> avec <strong>LUKS</strong> est la solution de chiffrement recommandée.</p><p>Gentoo GNU/Linux <a href='https://wiki.gentoo.org/wiki/DM-Crypt_LUKS'>maintient un guide</a> pour <strong>dm-crypt</strong> avec <strong>LUKS</strong>.</p><p>Arch GNU/Linux <a href='https://wiki.archlinux.org/index.php/Dm-crypt_with_LUKS'>maintient un guide</a> pour <strong>dm-crypt</strong> avec <strong>LUKS</strong>. Aussi utilisable pour Parabola GNU/Linux.</p>"
  "mail-server": "Serveur email"
  "groupware-server": "Serveur groupware"
  ...
  "xmpp-server-title": "Serveur XMPP"
  ...
  "hardware-software": "Solutions d'auto-hébergement"
  "self-hosting-notes": "--"
  "show-all": "Montrer tout"
  "service": "Service"
  "software": "Logiciel"
  "server-software": "Logiciel serveur"
  "p2p-software": "Logiciel pair-à-pair"
  "privacy-security": "Vie privée"
  "ip-exposed": "IP mis à nu"
  "ip-hidden": "IP caché"
  "advanced": "Avancé"
  ...
  "newbies-choice": "Facile d'utilisation"
  "editors-choice": "Choix de la rédaction"
  "most-stable": "Stable"
  "most-cutting-edge": "most cutting edge"
  "most-advanced": "Fonctionnalités les plus avancées"
  "most-paranoid": "Paranoïde"
  "friendly-defaults": "friendly defaults"
  "fsf-definition-title": "* Ce site web utilise la définition de logiciel libre de la <strong>Free Software Foundation</strong>."
  "fsf-quote": "L'expression &laquo;&nbsp;logiciel libre&nbsp;&raquo; veut dire que le logiciel respecte la liberté de l'utilisateur et de la communauté. En résumé, <strong>les utilisateurs ont la liberté d'exécuter, de copier, de distribuer, d'étudier, de modifier et d'améliorer le logiciel</strong>. Avec ces libertés, les utilisateurs (à la fois individuellement et collectivement) contrôlent le programme et ce qu'il fait pour eux."
  "eff-title": "Agissez contre PRISM au centre d'action de la <strong>Electronic Frontier Foundation</strong>."
  "eff-quote-1": "<strong>LA SURVEILLANCE MASSIVE MISE À NUE</strong>"
  ...
  "more": "plus &hellip;"
  "the": "La "
  "media-title": "Mentionné par les médias."
  "catalan": "Catalans"
  "german": "Allemands"
  "english": "Anglais"
  "spanish": "Espagnols"
