translations =
  ...
  "web-browser-note": "<p>Använd en kombination av <strong>Tor Browser</strong> och en valfri gratis webbläsare för att surfa på webben.</p> <p>Testa att använda <strong>Tor Browser</strong> så ofta som möjligt. Att surfa är långsammare med Tor, men mycket mer säkert.</p> <p>Notera: <strong>Mozilla Firefox</strong> är tekniskt sett inte helt fri mjukvara, eftersom Mozilla rekommenderar icke-fria tillägg på deras webbsida.</p>"
  "web-browser-plugins": "Tillägg för Webbläsare"
  "web-browser-addons-note": "<p>Skydda din integritet och hindra webbsidor från att spåra dig genom att installera Adblock Edge, Disconnect, HTTPS Everywhere, och NoScript i din webbläsare.</p> <p>Varför inte Adblock Plus? Adblock Plus visar &ldquo;acceptabla annonser&rdquo; som standard, och använder mer arbetsminne än <strong>Adblock Edge</strong>.</p> <p>Varfär inte Ghostery? Ghostery är en proprietär plugin. Använd <strong>Disconnect</strong> istället.</p>"
  "web-search": "Sökmotor"
  ...
  "maps-note": "<p>--</p>"
  "email-service": "Mejl-tjänster"
  "email-service-note": "<p><strong>Riseup</strong> är hostad i USA, om det nu spelar någon roll.</p><p>Varfär inte Hushmail? Se <a href='https://en.wikipedia.org/wiki/Hushmail#Compromises_to_email_privacy'>&ldquo;kompromisser till email integritet&rdquo;</a>.</p>"
  "email-client": "Mejl-klienter"
  "icedove": "Gratisversion av Mozilla Thunderbird."
  "email-client-note": "<p>Note: <strong>Mozilla Thunderbird</strong> är tekniskt sett inte helt gratis mjukvara eftersom Mozilla rekommenderar icke-gratis tillägg på deras webbsida..</p>"
  "email-encryption": "Mejl-kryptering"
  ...
  "instant-messaging": "Chattjänster"
  "jappix": "Instant messaging web application with advanced social networking features."
  "chatsecure-android": "Privat, säker OTR meddelandehantering för Android."
  "instant-messaging-note": "<p>Kolla in <strong>Cryptocat</strong> i webbläsartillägg sektionen också.</p></p>"
  "video-voip": "Videokonferens/VOIP"
  "video-voip-note": "<p><strong>Jitsi</strong> är en drop-in krypterad ersättare för nästan alla ändamål som Skype används för.</p><p><strong>Mumble</strong> är en open source röstchatt klient i samma stil som Ventrilo och TeamSpeak.</p><p><a href='http://www.webrtc.org/'>WebRTC</a> är ett uppkommande, lovande webbläsare-till-webbläsare kommunikations API."
  "social-networking": "Socialt nätverk"
  "protocol": "Protocol"
  "social-networking-note": "<p>--</p>"
  "cloud-storage": "Molntjänster"
  "cloud-storage-note": "<p>Varför inte MEGA? Medan MEGA är gratis som i öl, så är mjukvaran stängd kod.</p><p>Varför inte SpiderOak? SpiderOak är proprietär mjukvara.</p><p>Varför inte Tarsnap? Tarsnap är delvis proprietär och lagrar din data på Amazon Web Services.</p>"
  ...
  "media-publishing": "Publiceringssystem"
  ...
  "dns-provider": "DNS-Tjänster"
  "dns-provider-note": "<p>Google Public DNS loggar din ISP och platsinformation permanent för analys. Din IP adress lagras också i 24 timmar.</p><p><strong>OpenNIC</strong> har inte adopterat en officiell policy om loggning/integritet/anonymisering. Mer information <a href='http://wiki.opennicproject.org/Tier2'>här</a>.</p>"
  ...
  "invite-only": "endast-via-inbjudan"
  ...
  "fsf-definition-title": "*Denna webbplats använder <strong>Free Software Foundation&rsquo;s</strong> definition av fri programvara."
  "fsf-quote": "&ldquo;Fri programvara&rdquo; betyder programvara som respekterar användarens&rsquo; frihet och gemenskap. MAO, <strong> användarna har frihet att köra, kopiera, distribuera, studera, ändra och förbättra programvaran</strong>. Med dessa friheter, kan användarna (både individuellt och kollektivt) styra programmet och vad det gör för dem."
  "eff-title": "Ta till handling mot PRISM på <strong>Electronic Frontier Foundation</strong> handlingscenter."
  "eff-quote-1": "<strong>MASSIV ÖVERVAKNING AVSLÖJAD</strong>"
  "eff-quote-2": "Nyliga rapporter av Guardian och Washington Post bekräftar hemliga spionprogram på telefondata och Internet aktivitet. Det är dags för ett fullt utlägg av Amerikas hemliga spionprogram-och ett slut på okonstitionell övervakning."
  "more": "mera &hellip;"
  "the": ""
  "media-title": "Nämnd i media."
  "catalan": "Katalanska"
  "german": "Tyska"
  "english": "Engelska"
  "spanish": "Spanska"
  ...
  "license": "License"
  "changelog": "Changelog"
  "disclaimer": "Disclaimer: Att använda de rekommenderade projekten på denna sida kommer inte garantera att 100% av din kommunikation blir skyddad mot övervakningsstater. Var vänlig gör din egen research innan du litar på dessa mjukvaror med känslig information."
