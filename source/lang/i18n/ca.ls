translations =
  ...
  "site-introduction": "<strong>Decideix sortir de PISM, el programa mundial de vigilància de dades de la NSA.</strong> Deixa d'informar de les teves activitats a la xarxa al govern dels Estats Units amb aquestes alternatives lliures al software privatiu."
  "Menu": "Menu"
  "Proprietary": "Privatiu*"
  "Free Alternatives": "Alternativa lliure"
  "Notes": "Notes"
  ...
  "newbie's choice": "recomanat per a principiants"
  "editor's choice": "recomanació de l'autor"
  ...
  "more": "més &hellip;"
  The: "La"
  "site-media-index-title": "Cites als mitjans."
  Catalan: "Català"
  German: "Alemany"
  English: "Anglès"
  Spanish: "Espanyol"
  ...
  "License": "License"
  "Changelog": "Changelog"
  "site-disclaimer": "Exención de responsabilidad: Usar los proyectos recomendados en este sitio no garantiza que el 100% de tus comunicaciones estén protegidas contra estados de vigilancia. Por favor investiga por tu cuenta antes de confiar a estos programas tu información sensible."
